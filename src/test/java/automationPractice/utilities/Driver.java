...
public class Driver {
    ...
    // Here, the reasons we have singleton webdriver :
    //When we run the application , it will only run one driver (opened one window)
    // we only want to continue where we left on, because if you create nie driver, it will open new window and start from beginning
